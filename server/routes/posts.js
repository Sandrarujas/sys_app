...
// Importar middleware de subida desde config/cloudinary.js
...
router.post("/", authenticateToken, upload.single("image"), handleUploadErrors, createPostValidators, createPost)
...
router.put("/:id", authenticateToken, upload.single("image"), handleUploadErrors, createPostValidators, updatePost)
